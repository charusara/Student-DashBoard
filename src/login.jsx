...
const login = () => {
    ...
    const handleLogin = (event) => {
      event.preventDefault();
        ...
        const user = jsonData.find(user => user.registerNumber === registerNumber && user.password === password);
                ...
                <div className='card border-3 border-black' >
                    ...
                    <div className='card-body'>
                        <div className='form-group'>
                            <label>Register_Number<span className='errmsg'></span></label>
                            <input value={registerNumber} onChange={e=>setRegisterNumber(e.target.value)} className='form-control'></input>
                        </div>
                        <div className='form-group'>
                    ...
                    <div>
                        <button onClick={handleLogin} type="submit" className=' bg-blue-700 text-white'>Login</button>
                    </div>
                </div>
            </form>
        </div>
